    ...
    <div>
        <nav className="flex items-center justify-between px-72 h-16 shadow-lg">
            ...
            <div className="flex list-none items-center justify-between gap-12 font-semibold text-gray-500 ">
                <li className="cursor-pointer hover:text-blue-500 transition-all duration-300 text-lg">Start a search</li>
                ...
                <li className="cursor-pointer hover:text-blue-500 transition-all duration-300 text-lg">Post a job</li>
            </div>
